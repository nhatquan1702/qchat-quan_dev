...
class TabProfile extends StatefulWidget {
  ...
  @override
  State<TabProfile> createState() => _TabCallsState();
}

class _TabCallsState extends State<TabProfile> {
  ...
  void _openGallery(BuildContext context) async {
    ...
    context.read<PickerProvider>().pickedImage(pickedFile!);
    // ignore: use_build_context_synchronously
    Navigator.pop(context);
  }
  ...
  Widget _buildAvatarImg() {
    final imagePicked = context.watch<PickerProvider>().xFile;
    return InkWell(
      onTap: () {
